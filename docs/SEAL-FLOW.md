...
![SEAL loop: Archive complete](diagrams/seal-loop.png)

## This study’s units

Kill units 00–08 done. Atlas Units 10–14 done. Decide: atlas paper as written. Scribe complete. Archive complete (`EXPLORE.md`).

![SCENDO Archive complete](diagrams/scendo-units.png)

| Say in chat | When | What happens |
|---|---|---|
| **Archive** | After Scribe | **Done** — leftovers in [`EXPLORE.md`](../EXPLORE.md) |
| **Scribe** | After atlas Decide | **Done** — [`RESULTS.md`](../RESULTS.md) · [`manuscript.md`](manuscript.md) |
| **Decide** | After Gate F | **Done** — atlas paper as written |
| **Run** | After Unit 13 | **Done** — Unit 14 converge |
