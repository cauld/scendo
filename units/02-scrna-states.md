...
**Goal.** Decide which lineage buckets have an ECS state. Apply the `MS4A1` contamination filter. No ICI labels.
...
3. Drop non-B lineages with `MS4A1` detection ≥ 10% in that dataset.
